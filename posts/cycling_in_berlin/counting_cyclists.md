...
There are only 12 gaps, and all but two are resolved fairly quickly. I'm not sure what caused the two larger gaps.
...
![plot of chunk pairs_by_hour_plot](figure/pairs_by_hour_plot-1..svg)
