...
```{r noninformative_prior, echo = FALSE}
tibble(
    p = seq(-1, 1, 0.01),
    density = dunif(p, -1, 1)
  ) %>% 
...
With this assumption, there is a `r percent(1 - pbeta(0.4, alpha0, beta0))` chance of an average above 40%.
...
The probability that this normal distribution exceeds 1 is `r percent(1 - pnorm(1, mu, sigma))`.
