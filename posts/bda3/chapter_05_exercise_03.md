...
tldr: |
    Here's my solution to exercise 3, chapter 5, of Gelman's Bayesian Data
...
There is now a 64.8% probability of an extreme effect under the unpooled
model, which is a lot larger than 6.94% under the hierarchical model.
